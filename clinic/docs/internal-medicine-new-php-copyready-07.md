# Internal Medicine new.php Copyready - 07

## Objective
This file contains the final copy-ready `new.php` deliverable definition for the custom OpenEMR Internal Medicine form.
...
- must run inside OpenEMR encounter context
- must resolve:
  - `pid`
  - `encounter`
  - `userauthorized`
