# Internal Medicine report.php Copyready - 07

## Objective
This file contains the final copy-ready `report.php` deliverable definition for the custom OpenEMR Internal Medicine form.

---

## Final Real Target File
`interface/forms/internal_medicine/report.php`

---

## Final Runtime Requirements
- must load saved record by id
- must work safely in OpenEMR context
- must display a read-only report
- must escape output correctly
- should hide empty sections when practical

---

## Final Copy-Ready PHP Structure
```php
<?php
