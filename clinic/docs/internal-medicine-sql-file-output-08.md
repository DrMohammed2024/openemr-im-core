# Internal Medicine SQL File Output - 08

## Objective
This document contains the final output definition for the real SQL production file of the custom OpenEMR Internal Medicine form.
