# Internal Medicine table.sql Copyready - 07

## Objective
This file contains the final copy-ready SQL deliverable definition for the custom OpenEMR Internal Medicine form.
...
## Final SQL Table Name
`form_internal_medicine`

---

## Final Copy-Ready SQL
```sql
