...
| EVID-P0-009 | Requirements planning status | Requirements management plan and starter register | To identify | To verify | To verify | Evidence-needed | Planning-level only |
...
| EVID-P0-011 | Clinical safety planning status | Clinical safety case | To identify | To verify | To verify | Evidence-needed | No clinical-use authorization |
