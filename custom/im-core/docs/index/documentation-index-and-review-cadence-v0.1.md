...
| #95 | Pull Request Template and Stop Rules V0.1 | .github/pull_request_template.md | Governance Owner | Approved for current stage |
...
| #101 | Threat Model and Data Governance V0.1 | custom/im-core/docs/security/threat-model-and-data-governance-v0.1.md | Data Governance Owner / Privacy-Security Owner | Approved for current stage |
