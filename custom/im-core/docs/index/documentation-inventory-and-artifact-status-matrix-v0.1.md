...
| INV-TRACE-001 | Traceability Matrix V0.1 | custom/im-core/docs/validation/traceability-matrix-v0.1.md | Traceability | Needs population | Governance Owner / Technical Owner | Indexed path corrected; aligned after PR #214 | Provides documentation-stage traceability structure and current documentation-stage status alignment after PR #214 | Needs complete requirements-risk-control-test-evidence links and ongoing traceability maintenance | Does not prove verification, validation, compliance, certification, release readiness, production readiness, or clinical-use authorization |
| INV-EVID-001 | Evidence Registry and Evidence Templates V0.1 | custom/im-core/docs/evidence/evidence-registry-and-templates-v0.1.md | Evidence | Needs population | Documentation Owner / Evidence Reviewer | Indexed; aligned after PR #210 | Defines evidence templates and future evidence expectations, including PR execution, documentation-governance, and phase-gate future evidence placeholders | Needs populated evidence records and future evidence review | Does not provide runtime evidence, validation, compliance, certification, or release approval by itself |
| INV-RISK-001 | Risk Register V0.1 | custom/im-core/docs/risk/risk-register-v0.1.md | Risk | Needs population | Risk Owner / Clinical Safety Owner | Indexed; aligned after PR #211 | Provides documentation-stage risk register structure and initial planning context, including PR #209 / PR #210 risk-to-evidence linkage notes | Needs ongoing risk review, control linkage, residual risk review, and evidence linkage maintenance | Does not establish ISO 14971 compliance, validation, production readiness, or clinical-use authorization |
