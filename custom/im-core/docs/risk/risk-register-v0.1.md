...
| RISK-GOV-002 | AI-assisted advisory review is mistaken for human approval. | Future reviewer records may include AI-assisted recommendation fields without clear independent human decision confirmation. | Automation bias, unsupported merge confidence, or weak accountability. | High | Medium | High | CTRL-GOV-001 | Human ownership, formal approval record fields, and reviewer workflow review. | EVID-PR-FUTURE-001 | REQ-GOV-001 | Governance Owner | Medium | Open | Documentation-stage only; does not record actual reviewer approval. |
