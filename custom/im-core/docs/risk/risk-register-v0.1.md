...
For eligible documentation-stage risk-register changes, GPT performs advisory
risk mapping and the Project Owner makes the final accountable internal decision
under the AI-Assisted Solo-Owner Governance Policy V0.1. Separate specialist
approvals are not mandatory internal merge gates.

GPT may not accept risk, and the owner decision is non-independent. Operational
or clinical residual-risk acceptance and any runtime, PHI, deployment,
validation, compliance, certification, regulatory, or external gate remain
outside this model.
...
| RISK-GOV-002 | AI-assisted non-independent Project Owner review is mistaken for independent or specialist approval. | A valid owner decision record may be overstated or may omit the non-independence, author-owner-reviewer, evidence, conflict, rationale, or invalidation disclosures. | Automation bias, unsupported merge confidence, false independent-assurance claim, or weak accountability. | High | Medium | High | CTRL-GOV-001 | Mandatory Project Owner decision record, AI-assisted/non-independent disclosure, exact evidence and scope fields, and future external-gate preservation. | EVID-PR-FUTURE-001 | REQ-GOV-001 | Project Owner | Medium | Open | Eligible documentation-stage work only; does not record independent review, specialist approval, runtime authorization, validation, compliance, certification, or external assurance. |
| RISK-AUDIT-002 | PR evidence bundle is incomplete, stale, or overstated. | PR body evidence may omit changed files, source-of-truth, traceability, risk, evidence, checks, or post-merge verification status. | Weak auditability or unsupported decision-making. | Medium | Medium | Medium | CTRL-STOP-001 | PR evidence bundle minimum fields and claim-control review. | EVID-TRACE-FUTURE-001 | REQ-TRACE-001 | Documentation Owner | Medium | Open | Evidence bundle is a review aid only; does not replace checks or human review. |
| RISK-TRACE-002 | Governance-control traceability links become stale after PR changes. | PR #233-#236 relationships may not be maintained as governance artifacts evolve. | Traceability drift and weak linkage between PRs, controls, evidence, and reviewer decisions. | Medium | Medium | Medium | CTRL-DOC-002 | Traceability maintenance rules and post-merge verification. | EVID-TRACE-FUTURE-001 | REQ-TRACE-001 | Documentation Owner | Medium | Open | Current-stage traceability signal only; does not complete traceability. |
