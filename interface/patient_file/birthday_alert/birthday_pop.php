...
<body>
    <div style="padding: 15px; text-align: center">
        <p class="h2"><?php echo xlt('Happy Birthday');?>&ensp;<img src="<?php echo attr((string) OEGlobalsBag::getInstance()->get('images_static_relative')); ?>/balloons-154949_960_720.png" height="42" width="42"></p>
