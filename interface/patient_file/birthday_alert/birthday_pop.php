...
<body>
    <?php
    $imagesStaticRelative = OEGlobalsBag::getInstance()->get('images_static_relative');
    $imagesStaticRelative = is_string($imagesStaticRelative) ? $imagesStaticRelative : '';
    ?>
    <div style="padding: 15px; text-align: center">
        <p class="h2"><?php echo xlt('Happy Birthday');?>&ensp;<img src="<?php echo attr($imagesStaticRelative); ?>/balloons-154949_960_720.png" height="42" width="42"></p>
